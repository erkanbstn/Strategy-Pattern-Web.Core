...
using Strategy.Pattern.Core.UI.Repositories;
using System;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IProductRepository>(sp =>
            {
                ...
                var databaseType = (EDatabaseTypes)int.Parse(claim.Value);
                return databaseType switch
                {
                    EDatabaseTypes.SqlServer => new ProductRepositoryFromSqlServer(context),
                    EDatabaseTypes.MongoDb => new ProductRepositoryFromMongoDb(Configuration),
